...
fn song_8_6() {
    assert_eq!(
        ...
        "8 bottles of beer on the wall, 8 bottles of beer.\nTake one down and pass it around, 7 \
		 ...
		 one down and pass it around, 6 bottles of beer on the wall.\n\n6 bottles of beer on the \
		 wall, 6 bottles of beer.\nTake one down and pass it around, 5 bottles of beer on the \
		 wall.\n"
    );
}
